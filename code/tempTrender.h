...
class tempTrender {
	...
	void hottestTempPerYear(int yearToExtrapol); //Make a histogram of hottest temperature per year, then fit (and maybe if possible extrapolate to the given year)
=======
class tempTrender 
{
public:
